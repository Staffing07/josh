...
Step3: Here you can see the DOMAIN Text field. In this field you need to give the domain name\(Ex: For virtual host [http://josh56.test](http://josh56.test%29%29\)\)
